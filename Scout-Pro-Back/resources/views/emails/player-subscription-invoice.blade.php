...
<body>
    ...
    <div class="content">
        ...
        <p>Thank you for subscribing to Scout Pro! Here's your invoice for the membership purchase:</p>
        ...
        <p>Your membership is now active and you have full access to all premium features. The next payment will be automatically processed on {{ $expiry_date }}.</p>
